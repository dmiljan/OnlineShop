    ...
    public partial class CreateInitialStructure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTypeAttribute", x => new { x.ProductTypeId, x.AttributeId });
                    table.ForeignKey(
                        name: "FK_ProductTypeAttribute_Attribute_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "Attribute",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTypeAttributeValue", x => new { x.ProductTypeId, x.AttributeValueId });
                    table.ForeignKey(
                        name: "FK_ProductTypeAttributeValue_AttributeValue_AttributeValueId",
                        column: x => x.AttributeValueId,
                        principalTable: "AttributeValue",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTypeAttributeValue_ProductType_ProductTypeId",
                        column: x => x.ProductTypeId,
                        principalTable: "ProductType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProductSave", x => new { x.UserId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_UserProductSave_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProductSave_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTypeAttribute_AttributeId",
                table: "ProductTypeAttribute",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductTypeAttributeValue_AttributeValueId",
                table: "ProductTypeAttributeValue",
                column: "AttributeValueId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProductSave_ProductId",
                table: "UserProductSave",
                column: "ProductId");
        }
